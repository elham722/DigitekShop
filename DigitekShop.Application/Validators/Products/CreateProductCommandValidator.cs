    ...
    public class CreateProductCommandValidator : AbstractValidator<CreateProductCommand>
    {
        public CreateProductCommandValidator()
        {
            ...
            RuleFor(x => x.SKU)
                ...
                .MaximumLength(50).WithMessage("کد SKU نمی‌تواند بیشتر از 50 کاراکتر باشد")
                .Matches(@"^[A-Z0-9\-_]+$").WithMessage("کد SKU فقط می‌تواند شامل حروف بزرگ، اعداد، خط تیره و زیرخط باشد");
            ...
            RuleFor(x => x.Weight)
                .GreaterThan(0).WithMessage("وزن محصول باید بیشتر از صفر باشد")
                .LessThanOrEqualTo(1000).WithMessage("وزن محصول نمی‌تواند بیشتر از 1000 کیلوگرم باشد");
